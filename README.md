...
```sh
git clone https://github.com/AddMorePower/nomad-TXRM_parser.git
cd nomad-TXRM_parser
...
```sh
pip install dist/nomad-TXRM_parser-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Guillaume Gaisné | [guillaume.gaisne@esrf.fr](mailto:guillaume.gaisne@esrf.fr)
